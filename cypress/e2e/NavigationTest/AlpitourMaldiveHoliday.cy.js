describe('Alpitour Maldive Test', () => {
  ...
  it('Visits Alpitour site', () => {
    cy.visit('https://www.alpitour.it/')
  ...
  it('I leave the default selection', () => {
    ...
    cy.xpath("//label[@class='NewSearchBarComponent_labelList__nk0k-']//input[@value='VRN|VERONA']").click()
    cy.xpath("//button[@class='MuiButtonBase-root MuiButton-root MuiButton-contained NewSearchBarComponent_footerButton__1vHTM false MuiButton-containedPrimary']").click()
  })
  ...
  it('I click the first date available', () => {
    ...
    .invoke('text')
    .then((plpPrice) => {
        const plpPrice1 = plpPrice.replace(/[^\d]/g, '')
